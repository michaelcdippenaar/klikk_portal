  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        full: { type: 'boolean', description: 'When true, ignore modified_since and pull everything (38 calls / ~45 s for Klikk). Only needed to pick up deleted or voided invoices, which If-Modified-Since never returns; the weekly cron already does this.', default: false },
      },
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        modified_since: { type: 'string', description: 'Optional YYYY-MM-DD — only invoices updated since. Omit it: the backend then defaults to the last successful run minus a 3-day overlap (1 Xero call, ~1 s), instead of re-pulling every invoice.' },
